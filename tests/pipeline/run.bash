python ../../src/runWorkflow.py -f DolphinDev -i @INPUT=/etc -w $1 -u kucukura -o TEST7 -p /project/umw_biocore/bin/workflow/dolphin-tools-dev/default_params/Dolphin_v1.3_default.txt -r 9999 
