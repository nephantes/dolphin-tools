...
# TODO this can be used to copy files to web dir
	my $mvcom = '';
# $mvcom .= "&& mv x y";
        my $convmethylkit = " && echo -e \\\"chrBase\\tchr\\tbase\\tstrand\\tcoverage\\tfreqC\\tfreqT\\\" > $outdir/$samplename.methylkit.txt && awk '{if(\\\$5>0 && \\\$1 !~ /^#/ ){print \\\$1\\\".\\\"\\\$2\\\"\\\\t\\\"\\\$1\\\"\\\\t\\\"\\\$2\\\"\\\\t$strand\\\\t\\\"\\\$5\\\"\\\\t\\\"int(100*\\\$4)\\\"\\\\t\\\"(100-int(100*\\\$4))}}' $outdir/$samplename.G.bed | sort -k2,2b -k3,3n > $outdir/$samplename.methylkit.txt ";
